...
pub struct ScoreEntry {
    ...
    pub gender: String,
    // Only emails that satisfy the HTML5 regex specs standard will be accepted (some esoteric valid emails will not be accepted)
    #[validate(email)]
    pub email: String,
...
pub struct LeaderboardQueryRequest {
    #[validate(range(min = "constants::MIN_LEADERBOARD_LENGTH", max = "constants::MAX_LEADERBOARD_LENGTH"))]
